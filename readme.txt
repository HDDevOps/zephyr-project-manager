...
Tags: project manager, task manager, project, projects, task, tasks, files, discussions, collaboration, pm, zephyr, modern project
...
Zephyr Project Manager is a simple-to-use, yet sophisticated project manager for WordPress that will help you manage all your projects and tasks effectively and get work done.
...
* Fully featured Android mobile app

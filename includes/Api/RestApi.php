...
class RestApi {
	...
	public static function projects_dashboard( $data ) {
		...
		$dashboard_project_ids = Projects::get_dashboard_projects();
	...
	public function create_task( $data ) {
		...
		$start = $data['start'] !== '' ? date('Y-m-d H:i:s', strtotime($data['start'])) : $data['start'];
		$end = $data['end'] !== '' ? date('Y-m-d H:i:s', strtotime($data['end'])) : $data['end'];

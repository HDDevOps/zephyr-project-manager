...
<div class="zpm_top_bar">
	<div class="zpm_header">
		...
		<h3 class="zpm_header_text">
			...
			<span id="zpm-zephyr-info"><i class="dashicons dashicons-info"></i>
				<span id="zpm-zephyr-details-tooltip" class="zpm-tooltip-window">
					<p class="zpm-plugin-version version-basic">Zephyr Project Manager Basic V<?php echo Zephyr::getPluginVersion(); ?></p>
					<?php if (Zephyr::isPro()) : ?>
						<p class="zpm-plugin-version version-pro">Zephyr Project Manager Pro V<?php echo Zephyr::getProPluginVersion(); ?></p>
					<?php endif; ?>	
				</span>

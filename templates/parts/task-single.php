	...
	<div class="container">
		<div id="zpm_task_editor_settings" class="col-md-6">
			...
			<div class="zpm_options_row">
				<label class="zpm_label" for="zpm_edit_task_name"><?php _e( 'Task Name', 'zephyr-project-manager' ); ?></label>
				<input type="text" placeholder="<?php _e( 'Task Name', 'zephyr-project-manager' ); ?>" name="zpm_edit_task_name" id="zpm_edit_task_name" class="zpm_input" value="<?php echo $this_task->name; ?>" />
			</div>
			...
			<?php endif; ?>
			<button id="zpm_save_changes_task" name="zpm_save_changes_task" class="zpm_button" data-task-id="<?php echo $this_task->id; ?>"><?php _e( 'Save Changes', 'zephyr-project-manager' ); ?></button>

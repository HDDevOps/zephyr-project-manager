...
<div id="zpm_new_file_upload" class="zpm-modal">
	<h3 class="zpm_modal_header">New Attachment</h3>
	<input type="hidden" id="zpm_uploaded_file_name">
	<label class="zpm_label">Project</label>
	<?php Projects::project_select('zpm_file_upload_project'); ?>
	<div class="zpm_modal_footer">
		<button id="zpm_upload_file" class="zpm_button">Select File</button>
		<button id="zpm_submit_file" class="zpm_button">Upload Attachment</button>
	</div>
</div>
